...
fun OwnerSetupScreen(
    ...
    Scaffold { paddingValues ->
        Column(
            ...
            Text(
                text = "Register your canteen",
                style = MaterialTheme.typography.headlineMedium
            )
            Text(
                text = "Students will discover this canteen by college.",
            ...
            CanteenTextField(
                value = uiState.canteenName,
                onValueChange = viewModel::onCanteenNameChange,
                label = "Canteen name",
                modifier = Modifier.fillMaxWidth()
            )
